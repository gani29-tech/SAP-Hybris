...
import org.training.core.jalo.Bike;
...
import org.training.core.jalo.VehicleJob;
import org.training.core.jalo.VehicleSavingProcess;
...
public abstract class GeneratedTrainingCoreManager extends Extension
{
	...
	{
		return (Brand)item.getProperty( ctx, TrainingCoreConstants.Attributes.Product.BRAND);
	}
	...
	public Bike createBike(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( TrainingCoreConstants.TC.BIKE );
			return (Bike)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating Bike : "+e.getMessage(), 0 );
		}
	}
	
	public Bike createBike(final Map attributeValues)
	{
		return createBike( getSession().getSessionContext(), attributeValues );
	}
	...
	public Brand createBrand(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( TrainingCoreConstants.TC.BRAND );
	...
	public OrderTrackingEmailProcess createOrderTrackingEmailProcess(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( TrainingCoreConstants.TC.ORDERTRACKINGEMAILPROCESS );
	...
	public VehicleJob createVehicleJob(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( TrainingCoreConstants.TC.VEHICLEJOB );
			return (VehicleJob)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating VehicleJob : "+e.getMessage(), 0 );
		}
	}
	
	public VehicleJob createVehicleJob(final Map attributeValues)
	{
		return createVehicleJob( getSession().getSessionContext(), attributeValues );
	}
	
	public VehicleSavingProcess createVehicleSavingProcess(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( TrainingCoreConstants.TC.VEHICLESAVINGPROCESS );
			return (VehicleSavingProcess)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating VehicleSavingProcess : "+e.getMessage(), 0 );
		}
	}
	
	public VehicleSavingProcess createVehicleSavingProcess(final Map attributeValues)
	{
		return createVehicleSavingProcess( getSession().getSessionContext(), attributeValues );
	}
