...
public class ErrorResolver
{
	...
	/**
	 * Decided against replacing 'Stream.collect(Collectors.toList())' with 'Stream.toList()'
	 * to ensure the resulting list remains mutable. Otherwise, we could potentially break customers extension coding.
	 */
